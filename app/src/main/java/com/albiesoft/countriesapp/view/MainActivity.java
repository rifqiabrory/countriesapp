package com.albiesoft.countriesapp.view;
...
import com.albiesoft.countriesapp.R;
import com.albiesoft.countriesapp.adapter.CountryListAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void observerViewModel(){
        ...
        viewModel.countryLoadedError.observe(this, isError -> {
            if(isError != null){
